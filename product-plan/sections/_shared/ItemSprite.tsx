...
export function ItemSprite({
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center justify-center overflow-hidden rounded-md bg-gradient-to-br ${RARITY_BG[rarity]} ring-1 ${RARITY_RING[rarity]} ${RARITY_GLOW[rarity]} shadow-sm ${className}`}
