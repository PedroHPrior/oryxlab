...
export function BuildColumn({
  ...
  return (
    <article
      className="oryx-card-hover relative flex w-[280px] shrink-0 flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm hover:border-amber-400/40 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 sm:w-[300px]"
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 rounded-lg border border-zinc-200/70 bg-gradient-to-br from-zinc-50 to-zinc-100/60 p-3 dark:border-zinc-800/70 dark:from-zinc-950 dark:to-zinc-900/60">
        <div className="col-span-3 border-b border-zinc-200/60 pb-2 dark:border-zinc-800/60">
          <Stat label="DPS" value={ds.dps} delta={delta("dps")} size="xl" />
        </div>
        <div className="col-span-2">
          <Stat label="EHP" value={ds.ehp} delta={delta("ehp")} size="md" />
        </div>
        <div>
          <Stat label="DEF" value={ds.def} delta={delta("def")} size="md" />
        </div>
        ...
        <Stat label="VIT" value={ds.vit} delta={delta("vit")} size="sm" />
        <Stat label="MP" value={ds.mp} delta={delta("mp")} size="sm" />
      </div>
